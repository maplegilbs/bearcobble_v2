...
export default function Fix_List_Add_Form({ isVisible, setIsVisible, updateFixList }) {
                    ...
                    <div className={`${fix_list_form_styles.form_input}`}>
                        ...
                        <div className={fix_list_form_styles.radio_inputs}>
                            <div className={fix_list_form_styles.radio_input}>
                                ...
                                <input type="radio" id="high_priority" name="priority" value="0" checked={formValues.priority === "0"} required="" onChange={e => formValuesChangeHandler(e)} />
                            </div>
                            <div className={fix_list_form_styles.radio_input}>
                                <label htmlFor='medium_priority'>Medium</label>
                                <input type="radio" id="medium_priority" name="priority" value="1" checked={formValues.priority === "1"} required="" onChange={e => formValuesChangeHandler(e)} />
                            </div>
                            <div className={fix_list_form_styles.radio_input}>
                                <label htmlFor='low_priority'>Low</label>
                                <input type="radio" id="low_priority" name="priority" value="2" checked={formValues.priority === "2"} required="" onChange={e => formValuesChangeHandler(e)} />
                            </div>
                        </div>
