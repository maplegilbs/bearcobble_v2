        ...
        [
            {
                section1: {
                    ...
                    vacuum_reading: rawData.database.table.row[1].data_EXT.PRESSURE,
                    reading_time: rawData.database.table.row[1].timeTag_EXT.realtime
                },
                section2: {
                    section_name: 'Section 2',
                    vacuum_reading: rawData.database.table.row[1].data_EXT.PRESSURE2,
                    reading_time: rawData.database.table.row[1].timeTag_EXT.realtime
                },
                section3: {
                    section_name: 'Section 3',
                    vacuum_reading: rawData.database.table.row[2].data_EXT.PRESSURE2,
                    reading_time: rawData.database.table.row[2].timeTag_EXT.realtime
                },
                section4: {
                    section_name: 'Section 4',
                    vacuum_reading: rawData.database.table.row[3].data_EXT.PRESSURE,
                    reading_time: rawData.database.table.row[3].timeTag_EXT.realtime
                },
                section5: {
                    section_name: 'Section 5',
                    vacuum_reading: rawData.database.table.row[3].data_EXT.PRESSURE2,
                    reading_time: rawData.database.table.row[3].timeTag_EXT.realtime
                },
            },
            {
