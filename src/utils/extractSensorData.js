        ...
        [
            {
                ...
                section3: {
                    ...
                    status: rawData.database.table.row[1].status_EXT.statusCode
                },
                section4: {
                    section_name: 'Section 4',
                    vacuum_reading: rawData.database.table.row[2].data_EXT.PRESSURE+rawData.database.table.row[2].configuration_EXT.CALIBZERO,
            ...
            },
            {
                tank1: {
                    tank_name: 'Tank 1',
                    tank_level: rawData.database.table.row[3].data_1,
                    reading_time: rawData.database.table.row[3].timeTag_EXT.realtime,
                    status: rawData.database.table.row[3].data_EXT.ERRCODE
                },
                tank2: {
                    tank_name: 'Tank 2',
